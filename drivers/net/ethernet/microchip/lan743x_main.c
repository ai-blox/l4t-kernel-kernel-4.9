...
static int lan743x_phy_open(struct lan743x_adapter *adapter)
{
	...
	/*toussi phy_remove_link_mode(phydev, ETHTOOL_LINK_MODE_1000baseT_Half_BIT); */

	/* support both flow controls */
	/* toussi phy_support_asym_pause(phydev); */
					   ...
					   struct ifreq *ifr)
{
	...
	if (mdio_phy_id_is_c45(mii_data->phy_id)) {
		...
		/* toussi devad = mdiobus_c45_addr(devad, mii_data->reg_num); */ 
	} else {
